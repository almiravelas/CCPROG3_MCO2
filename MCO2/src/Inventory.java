...
public class Inventory{
    ...
    public boolean hasChosenStarterCreature() {
        return hasChosenStarterCreature;
    }
    ...
    public void listAll() {
        ...
        if (hasChosenStarterCreature && activeCreature != null) {
            ...
            System.out.println("opt Health: "+ activeCreature.getHealth());
        ...
        if (!creatures.isEmpty()) {
            ...
            for (Creatures creature : creatures) {
                if (creature != activeCreature) {
                    ...
                    System.out.println("opt Health: "+ creature.getHealth());
